...
export const translations = {
  es: {
    ...
    module_rag: 'FAISS indexado - 24 chunks',
    module_cache: '15 entradas en cache',
    module_voz: 'Whisper listo',
    module_vision: 'No configurado',
    module_tools: '3 herramientas activas',
    ...
    top_news_label: 'Noticias mas buscadas',
    tokens_consumed: 'Tokens consumidos hoy',
    tool_calls: 'Llamadas a herramientas',
    cache_hits: 'Hits de cache',
    total_messages: 'Mensajes totales',
    estimated_cost: '~$0.014 USD estimado',
    last_24h: 'ultimas 24h',
    hit_rate: '70% tasa de acierto',
  ...
  en: {
    ...
    module_rag: 'FAISS indexed - 24 chunks',
    module_cache: '15 cache entries',
    module_voz: 'Whisper ready',
    module_vision: 'Not configured',
    module_tools: '3 active tools',
    ...
    top_news_label: 'Most searched topics',
    tokens_consumed: 'Tokens consumed today',
    tool_calls: 'Tool calls',
    cache_hits: 'Cache hits',
    total_messages: 'Total messages',
    estimated_cost: '~$0.014 USD estimated',
    last_24h: 'last 24h',
    hit_rate: '70% hit rate',
